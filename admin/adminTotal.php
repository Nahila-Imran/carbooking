...
<html>
    ...
    <h1 style="color: white;">Find the Best <span style="color: #3CB371;">CarForYou</span></h1>
    </header>
        <div class="container">
            <div class="head">
                <div class="nav">
                <ul>
                    ...
                    <li><a class="active" href="adminTotal.php">Total Earnings</a></li>
                ...
                <div style="margin-left: 23%; padding:1px 25px;height:600px;">
                    <h1 style="font-size: 40px; margin-top: 10%; ">Grand <span style="color: #3CB371;">Total Fare</span></h1>
               <?php 
