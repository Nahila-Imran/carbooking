...
<html>
    ...
    <h1 style="padding-top: 4%;">Find the Best <span style="color: #AC0000;">CarForYou</span></h1>
    </header>
        <div class="container">
            <div class="head">
                <div class="nav">
                <ul>
                    ...
                    <li><a class="active" href="sortRides.php">Sort Rides</a></li>
            ...
            <div style="margin-left: 23%;padding:40px 16px;height:650px;">
                <h1>Sorted <span style="color: #AC0000;">Booking Details</span></h1>
                <table width="80%">
